    ...
    static void GerarCSV()
    {
        ...
        using (var fluxoDeArquivo = new FileStream(enderecoArquivo, FileMode.Open))
        {
            ...
            while (!leitor.EndOfStream)
            {
                ...
                var msg = $"Titular: {contaCorrente.Titular.Nome} | Conta numero {contaCorrente.Numero}, Agencia: {contaCorrente.Agencia}, Saldo: {contaCorrente.Saldo} ";
